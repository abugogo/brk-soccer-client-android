...
public class ShowSettingsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			case 1:
				IDAOPlayer p = RemoteDBAdapter.getPlayer(sUrl, "3");
	...
	private void showPlayerInfoOnScreen(IDAOPlayer p) {
	...
	private void showPlayersInfoOnScreen(List<IDAOPlayer> pList) {
		StringBuilder builder = new StringBuilder();
